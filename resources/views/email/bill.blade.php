    ...
    <tr>
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <tr>
                    <td align="center"  bgcolor="#837b33" class="container-padding">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="https://i.postimg.cc/kX0PhSQg/Email-18-Intro.png" width="190" border="0" alt="intro">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    <div  >
                                        Many more products waiting for you to explore!
                                    </div>
                                </td>
                            </tr>
                            <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr  >
                    <td align="center"  bgcolor="#FFFFFF">
                        <img style="width:50px;border:0px;display: inline!important;" src="https://i.postimg.cc/tJzRJmcq/Arrow.png" width="50" border="0"       alt="arrow">
                    </td>
                </tr>
            </table>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="left" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:20px;line-height:26px;font-weight:400;font-style:normal;color:#343e9e;text-decoration:none;letter-spacing:0px;">
                                    <div  style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;color:#2d2e31;">
                                        Product {{$increment+=1}}
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                        <tr>
                                            <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                <div  >
                                                    (If you have any questions or feedback, just <a href="mailto:athanh2002kt@gmail.com" style="color:#ed6e7a;text-decoration: underline;">reply to this email</a>)
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td align="center"  bgcolor="#f0f0f0" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.facebook.com/dthanh1508"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/Y2yHYZjg/Facebook.png" width="36" border="0" alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.instagram.com/tha_nh08/"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/hPzqrs7Y/Instagram.png" width="36" border="0" alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://twitter.com/"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/QMsGjrnL/Twitter.png" width="36" border="0" alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://www.pinterest.com/dthanh1508/"><img style="width:36px;border:0px;display: inline!important;" src="https://i.postimg.cc/dVGcM06m/Pinterest.png" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="tel:0982934861" style="color:#6e6e6e;"><span>+(84) 982 934 861</span></a>
                                </td>
                            </tr>
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="mailto:athanh2002kt@gmail.com"    style="color:#6e6e6e;"><span>athanh2002kt@gmail.com</span></a> - <a style="color:#6e6e6e;"><span>dthanh1508</span></a>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" style="font-size:30px;line-height:30px;" >&nbsp;</td>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr  >
                                                        <td align="center">
                                                            <a href="https://www.apple.com/app-store/"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="https://i.postimg.cc/MT98srDC/App-Store.png" border="0"  alt="icon"></a>
                                                        </td>
